...
public class MergeSortForPoints {
    private static boolean compare(Point a, Point b, int wrtXorY) {
        if(wrtXorY == 0) {
    ...
    private static void merge(Point[] arr1, Point[] arr2, Point arr[], int wrtXorY) {
        int i=0, j=0;
    ...
    static void mergeSort(Point[] arr, int wrtXorY) {
        int n = arr.length;
