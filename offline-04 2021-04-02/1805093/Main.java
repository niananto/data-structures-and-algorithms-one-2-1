...
//        System.out.println();
        ...
        while (true) {
            ...
            if (menuInput == 1) {
                ...
                int currentInput = Integer.parseInt(sc.nextLine());
                System.out.println(bst.getInOrderSuccessor(new BinarySearchTreeNode(currentInput)));
            } else if (menuInput == 4) {
                System.out.println("Insert the integer you would like to get the predecessor of");
                int currentInput = Integer.parseInt(sc.nextLine());
                System.out.println(bst.getInOrderPredecessor(new BinarySearchTreeNode(currentInput)));
            } else if (menuInput == 5) {
